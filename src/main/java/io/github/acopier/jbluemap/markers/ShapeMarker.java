...
public class ShapeMarker extends BaseMarker {
    public final List<Position> shape;
    public final int shapeY;
    public final String detail;


    public ShapeMarker(String key, String label, Position position, List<Position> shape, int shapeY, String detail) {
    ...
    public static ShapeMarker fromResponse(String key, Map<String, Object> r) {
        ...
        Number sy = (Number) r.getOrDefault("shape-y", 0);
        String detail = (String) r.get("detail");
        return new ShapeMarker(key, label, pos, shape, sy.intValue(), detail);
    }
}